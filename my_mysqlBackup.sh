...
mysql_password="p@ssw0rd" #MySQL备份用户的密码
mysql_host="192.168.20.190"
mysql_port="3306"
mysql_charset="utf8mb4" #MySQL编码
backup_db_arr=("flarum" "flarum_wcl") #要备份的数据库名称，多个用空格分开隔开 如("db1" "db2" "db3")
backup_location="/home/w123/bak" #备份数据存放位置，末尾请不要带"/",此项可以保持默认，程序会自动创建文件夹
